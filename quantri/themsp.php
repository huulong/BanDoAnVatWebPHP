...
if(isset($_POST["submit"])){
    ...
    if(isset($ten_sp) && isset($gia_sp) && isset($khuyen_mai) &&
        ...
        $sql = "insert into sanpham(ten_sp,gia_sp,khuyen_mai,trang_thai,chi_tiet_sp,id_dm,anh_sp,dac_biet) 
        values
        ('$ten_sp','$gia_sp','$khuyen_mai','$trang_thai','$chi_tiet_sp','$id_dm','$anh_sp','$dac_biet')";
