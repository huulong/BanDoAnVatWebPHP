        ...
        <div class="container">
            <div class="row">
                <div id="logo" class="col-md-3 col-sm-12 col-xs-12">
                    <h1>
                        <a href="index.php"><img src="img/home/logo.png" style="width:100px;"></a>
                    </h1>
                </div>
                <!-- timkiem -->
                <?php
            ...
            <div class="container">
                <div class="row">
                    <div id="logo-f" class="col-md-3 col-sm-12 col-xs-12 text-center">
                        <img src="img/home/logo.png" style="width:100px;">
                    </div>

                    <div id="hotline" class="col-md-3 col-sm-12 col-xs-12">
                        <h3>Hotline</h3>
                        <p>Phone Sale: (+84) 038 2333 246</p>
                        <p>Email: </p>
                    </div>
                    <div id="contact" class="col-md-6 col-sm-12 col-xs-12">
                        <h3>Contact Us</h3>
                        <p>Address : 70 Nguyễn Huệ - Huế</p>
                    </div>
                    <div id="scroll">
